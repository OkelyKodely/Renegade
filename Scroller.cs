...
class Scroller
{
    ...
    private Image heart, thebg, thebg2, bg, bg2, antt, antagonist, antagonist2, antagonist3, antagonist4, antagonist5, soldierimg, mylead, mybullet, myjet, myexplosion, enmy;
    ...
    public void Draw()
    {
        ...
        try
        {
            g.DrawImage(thebg, x, y, panel.Width, panel.Height);
            g.DrawImage(thebg2, x+1280, y, panel.Width, panel.Height);
        }
        catch (Exception xx)
        {
        }
    ...
    public void DrawLife()
    {
        ...
        for (int i = 0; i < soldier.life / 1000; i++)
        {
            ...
            try
            {
                g.DrawImage(heart, 60 + x * 13, remx, 13, 20);
            }
            catch (Exception ex)
            {
            }
        ...
        try
        {
            g.DrawString("Life: ", new Font("Arial", 32), new SolidBrush(Color.Black), 0, 0);
        }
        catch (Exception ex)
        {
        }
